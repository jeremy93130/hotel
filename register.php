...
<div class="container">
    <form method="post" action="./models/inscription.php">
        ...
        <div class="mb-3">
            ...
            <input type="email" class="form-control" id="emailaddress" aria-describedby="emailHelp" name="emailAddress"required>
        </div>
        ...
        <div class="mb-3">
            ...
            <input type="date" class="form-control" id="birthdaydate" aria-describedby="emailHelp" name="birthday"required>
        </div>
